                    ...
                    <form action="{{ route("registrasi_proses")}}" method="POST" enctype="multipart/form-data">
                        ...
                        @enderror
                            ...
                            <input
                                ...
                                id="no_identitas" placeholder="Nomor Identitas" type="number" name="identitas" value="{{ old('identitas')}}" required/>
                        </div>
                        <div class="mb-4">
                        ...
                        @enderror
                            ...
                            <input
                                class="w-full px-4 py-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline md:text-base"
                                id="email" placeholder="Email" type="email" name="email" value="{{ old('email')}}" required/>
                        </div>
                        <div class="mb-4">
                            @error('nomor_telepon')
                            <div class="mt-1 text-red-500">{{ $message }}</div>
                        @enderror
                            ...
                            <input
                                class="w-full px-4 py-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline md:text-base"
                                id="no_tlp" placeholder="contoh : 089765432345" type="number" name="nomor_telepon" value="{{ old('nomor_telepon')}}" required/>
                        </div>
                        <!-- input nama pengguna -->
                        <div class="mb-4">
                            @error('nama')
                            ...
                            <input
                                class="w-full px-4 py-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline md:text-base "
                                id="username" placeholder="Nama Lengkap" type="text" name="nama" value="{{ old('nama')}}" required/>
                        ...
                        @enderror
                            ...
                            <input
                                class="w-full px-4 py-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline md:text-base"
                                id="plate" placeholder="Plat Kendaraan" type="text" name="no_plat" value="{{ old('no_plat')}}" required/>
                        </div>
                        ...
                        @enderror
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">*PNG, JPG or JPEG

...
@section('main')
        ...
        <div class="grid w-9/12 grid-cols-1 px-5 mx-6">
            <table class="text-sm font-medium">
                <thead class="bg-[#95AFE5]">
                    <tr>
                        <th class="px-1 py-2 text-sm font-bold rounded-tl-lg w-[5rem]">No. Slot</th>
                        <th class="px-1 py-2 text-sm font-bold w-[30rem]">Keterangan</th>
                        <th class="px-1 py-2 text-sm font-bold rounded-tr-lg">Aksi</th>
                    </tr>
                </thead>
    ...
    @endif -->
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            {{ $errors->has('keterangan') ? 'border-red-500' : '' }}">
                                    ...
                                    <option value="Tersedia" {{ old('keterangan') == 'Tersedia' ? 'selected' : '' }}>
                                        Tersedia</option>
                                    <option value="Terisi" {{ old('keterangan') == 'Terisi' ? 'selected' : '' }}>
                                        Terisi</option>
        ...
        <div id="validation-popup" class="fixed inset-x-0 top-0 z-50 justify-center hidden">
            <div

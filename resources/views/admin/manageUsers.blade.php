    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center p-4 space-x-4 md:p-5">
                <img src="{{ asset('storage/' . $pengguna->foto_profile) }}" alt="User Profile" class="object-cover w-48 h-56 rounded-md -pt-5">
                <div class="space-y-1">
                    ...
                    <div class="text-base text-gray-500 dark:text-gray-400">: {{ $pengguna->jenis_kendaraan }}</div>

...
@section('main')
    <div class="p-5">
        <a href="#" onclick="history.back();" class="flex items-center mt-4">
            <i class="mr-2 text-xl fas fa-arrow-left text-gray-50"></i>
            <span class="text-xl font-semibold text-gray-50">Kembali</span>
        </a>
        <select id="zoneSelect" class="w-1/3 p-3 border border-gray-300 rounded mt-8">
    ...
    <div class="grid w-screen grid-cols-1 gap-4 px-4 md:grid-cols-2 pb-4">

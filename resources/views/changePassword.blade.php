...
@section('main')
    <main class="container flex-grow px-4 py-8 mx-auto">
        <div class="max-w-md mx-auto">
            <div class="flex items-center mb-6">
                <a href="#" class="flex items-center ">
                    <i class="mr-2 fas fa-arrow-left text-gray-50 text-xl"></i>
                ...
                <form>
                    <div class="mb-4">
                        ...
                        <div class="flex items-center px-3 py-1 border rounded-lg">
                            ...
                            <input class="w-full ml-2 text-sm border-none focus:ring-0" id="old-password" placeholder="Kata Sandi lama" type="password"/>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center px-3 py-1 border rounded-lg">
                            <i class="text-gray-400 fas fa-lock"></i>
                            <input class="w-full ml-2 text-sm border-none focus:ring-0" id="new-password" placeholder="Kata Sandi Baru" type="password"/>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center px-3 py-1 border rounded-lg">
                            <i class="text-gray-400 fas fa-lock"></i>
                            <input class="w-full ml-2 text-sm border-none focus:ring-0" id="confirm-password" placeholder="Konfirmasi Kata Sandi Baru" type="password"/>
        ...
        <!-- <div class="max-w-md mx-auto">
            <div class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-lg">
                <h2 class="mb-6 text-xl font-bold text-center">Tambah Kendaraan</h2>
                <form>
                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-bold text-gray-700" for="old-password">
                            Kata Sandi lama
